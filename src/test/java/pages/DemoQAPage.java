...
public class DemoQAPage {
    ...
    public List<WebElement> tumSatirlarWebElementiList;

    public void sutunYazdir(int sutun) {
    //   "((//div[@class='rt-tr-group'])[3]//div[@class='rt-td'])[4]"

        int satirSayisi=tumSatirlarWebElementiList.size();
        String dinamikXpath;
        WebElement geciciElement;
        System.out.println("Basliklar listesi :"+basliklarWebelementiListesi.get(sutun-1).getText());
        ...
        for (int i=1; i<=satirSayisi; i++){
            ...
            System.out.println("Gecici element :"+geciciElement.getText());
        }
    }
